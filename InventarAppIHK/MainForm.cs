...
{//datagridView mit join alles anzeigen
    public partial class MainForm : Form
    {
        ...
        private void btnCategory_Click(object sender, EventArgs e)
        {
            ...
            Utility.openChildForm(panelMain, new CategoryForm());            
        }
        ...
        private void btnProduct_Click(object sender, EventArgs e)
        {
            ...
            Utility.openChildForm(panelMain, new ProductForm());           
        }
        ...
        private void btnLocation_Click(object sender, EventArgs e)
        {
            ...
            Utility.openChildForm(panelMain, new LocationForm());           
        }
        ...
        private void btnOrder_Click(object sender, EventArgs e)
        {
            ...
            Utility.openChildForm(panelMain, new TotalForm());           
        }
        ...
        {           
            ...
            DesignChartControl.Location(chart2);
            DesignChartControl.Location(chart3);
            DesignChartControl.FillChart(chart4);
